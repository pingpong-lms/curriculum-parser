...
class SkolverketFileArchiveTest {
    ...
    fun testGR() {
        ...
        val expectedSyllabusTypes = setOf(SyllabusType.GR, SyllabusType.GRSAM, SyllabusType.GRS, SyllabusType.GRSPEC)
        Assert.assertEquals(expectedSyllabusTypes, sf.getTypes())
